...
object HttpUrlConnectionDataAgentImpl : NewsDataAgent {
    override fun getAllNews(
        ...
        GetNewsTask(accessToken,onSuccess= onSuccess, onFailure = onFailure).execute()
    }

    }
    class GetNewsTask(val accessToken: String, val onSuccess: (List<NewsVO>) -> Unit, val onFailure: (String) -> Unit):AsyncTask<Void,Void,GetAllNewsResponse?>(){
